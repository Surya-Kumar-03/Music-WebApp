...
const Navbar = () => {
	...
	const [loggedIn, setLoggedIn] = useState(true); // true if user is logged in
	const [isAdmin, setIsAdmin] = useState(true); // true if user is logged in
	...
	return (
		<>
			...
			<div className='z-10 border-b-2 w-full border-gray-200 sticky top-0 backdrop-filter backdrop-blur-md bg-white bg-opacity-40'>
				<div className='mx-auto container sm:px-6 lg:px-8'>
					<div className='relative flex h-16 items-center justify-between '>
						...
						<div className='flex justify-around sm:justify-end w-full'>
							...
							<div className='inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0'>
								...
								{loggedIn ? (
									...
									<span
										className='font-semibold cursor-pointer p-2 hover:bg-slate-200 rounded-md'
										onClick={() => {
											setLoginForm(true);
										}}
									>
